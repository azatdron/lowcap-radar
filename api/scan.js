...
function sectorOk(c,sector){if(sector==="auto")return true;const t=(c.name+" "+c.symbol+" "+(c.description||"")+" "+(c.categories||[]).join(" ")).toLowerCase();return (TERMS[sector]||[]).some(x=>t.includes(x))}
